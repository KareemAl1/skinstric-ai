...
export default function Introduction() {
  ...
  const handleSubmit = () => {
    if (!name.trim()) return;
    router.push("/introduction/location");
  };
  ...
  return (
    <main className="fixed inset-0 overflow-hidden" style={{ backgroundColor: "#FCFCFC" }}>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 z-10">
        ...
        <input
          ...
          style={{
            ...
            color: name ? "#1A1B1C" : "#A0A4AB",
            borderBottom: `1px solid ${isFocused || name ? "#1A1B1C" : "#A0A4AB"}`,
            paddingBottom: 8,
            width: 500,
      ...
      {/* Back */}
      <Link href="/" className="absolute flex items-center gap-4 no-underline z-10"
