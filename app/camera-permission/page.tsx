...
export default function CameraPermission() {
  ...
  const handleAllow = () => {
    navigator.mediaDevices.getUserMedia({ video: true })
      .then(() => router.push("/camera-setup"))
      .catch(() => alert("Camera access denied. Please allow camera access in your browser settings."));
  };
  ...
  return (
    <main className="fixed inset-0 overflow-hidden" style={{ backgroundColor: "#FCFCFC" }}>
      ...
      {/* Right diamond with gallery icon */}
      <div className="absolute" style={{ left: "75%", top: "48%", transform: "translate(-50%,-50%)" }}>
        <div className="relative" style={{ width: 300, height: 300 }}>
          <div className="d1" style={{ width: 284, height: 284, border: "2px dashed #A0A4AB", opacity: 0.3 }} />
          <div className="d2" style={{ width: 262, height: 262, border: "2px dashed #A0A4AB", opacity: 0.6 }} />
          <div className="d3" style={{ width: 238, height: 238, border: "2px dashed #A0A4AB" }} />
      ...
      {/* Permission modal */}
      <div className="absolute z-20" style={{ left: "25%", top: "52%", transform: "translateX(-20%)" }}>
        <div style={{ backgroundColor: "#1A1B1C", width: 280, padding: "24px 24px 16px" }}>
          <p style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.06em", color: "white", marginBottom: 32 }} className="uppercase">
            Allow A.I. to access your camera
          </p>
          <div className="flex justify-end gap-6">
            <Link href="/testing" style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.06em", color: "white", opacity: 0.6, textDecoration: "none" }} className="uppercase">
              Deny
            </Link>
            <button onClick={handleAllow}
              style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.06em", color: "white", background: "none", border: "none", cursor: "pointer" }}
              className="uppercase">
              Allow
            </button>
          </div>
